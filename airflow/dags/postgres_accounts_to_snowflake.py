...
from tables.accounts_config import tables_config, batch_size
...
with DAG(
    'postgres_accounts_to_snowflake',
    default_args=default_args,
    description='Transfer accounts data from PostgreSQL to Snowflake',
    catchup=False,
